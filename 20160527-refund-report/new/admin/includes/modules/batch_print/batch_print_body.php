...
//$orders_statuses[] = array('id' => 110, 'text' => 'Pending or GoogleProcessing');
...
<td>
       ...
       <tr class="dataTableRow">
		     <td class="dataTableContent" align="center" width="50%">Or</td>
         <td width="50%" class="dataTableContent"></td>
       </tr>
       <tr class="dataTableRow">
		     <td class="dataTableContent" width="50%"><?php echo TEXT_DATES_ORDERS_EXTRACTRED; ?></td>
         <td width="50%" class="dataTableContent">
                   <?php echo TEXT_FROM; ?><?php echo tep_draw_input_field('startdate', '', 'id="start_date"') . ' <small>(YYYY-MM-DD)</small>'; ?><br />&nbsp;&nbsp;
                   <?php echo TEXT_TO; ?><?php echo tep_draw_input_field('enddate', '', 'id="end_date"') . ' <small>(YYYY-MM-DD)</small>'; ?>
...
$('#end_date').datepicker({
  dateFormat: 'yy-mm-dd'
       ...
       <tr class="dataTableRow">
		     <td class="dataTableContent" width="50%"><?php echo TEXT_ORDER_NUMBERS_RANGES_EXCLUDE; ?></td>
         <td width="50%" class="dataTableContent"><?php echo tep_draw_input_field('exinvoicenumbers'); ?></td>
       </tr>
       <tr class="dataTableRow">
       ...
       <tr class="dataTableRow">
         ...
         <td width="50%"><?php echo tep_draw_selection_field('show_cc', 'checkbox', true, false); ?></td>
       </tr>
       <tr class="dataTableRow">
